...
def greet() -> None:
    ...
    print(f"Hello { player }! Here's the ball, get on the court! \U0001F3C0 \n")
...
def choice1()-> None:
    ...
    if choice1 == "Shoot a three":
        points = points + 1
        print("You missed \U0001F622. Duke rebounds. RUN back!")
    else:
...
def end()-> None:
    print(f"Carolina Victory! 82-78! Awesome job. What are you still doing here? Let's go to Franklin!! \U0001F973 \U0001F40F")
